            ...
            <div className="hero  bg-black mt-0.5 rounded-lg text-white">
                <div className="hero-content flex-col lg:flex-row-reverse gap-20">
                    ...
                    <div>
                        ...
                        <h1 className="text-2xl font-bold"> A web Developer </h1>
                        <div className='w-80'>
                        ...
                        <a target='_blank' href="https://drive.google.com/file/d/1TzdeqqX8jYgQBuJ_TZkPP8LG05Kk5pGt/view?usp=sharing">
